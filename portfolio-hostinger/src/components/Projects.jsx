    ...
    return (
        <div id='projects' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
            ...
            <p className='text-center py-8'>
                The following are some of my projects as a web developer, kindly visit <a href= '#resume' className='text-[#001b5e] font-bold'>resume</a> for more details on other projects
            </p>
